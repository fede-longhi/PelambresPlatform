...
import { updateCourse, CourseFormState } from '@/lib/actions/course-actions';
...
export function EditCourseForm({ initialData }: EditCourseFormProps) {
    const updateCourseWithId = updateCourse.bind(null, initialData.id);
    ...
    const [title, setTitle] = useState((state.payload?.get('title') as string) ?? initialData.title);
    const [slug, setSlug] = useState((state.payload?.get('slug') as string) ?? initialData.slug);
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="space-y-2">
                    ...
                    <Input 
                        id="duration" 
                        name="duration" 
                        defaultValue={(state.payload?.get('duration') as string) ?? initialData.duration}
                        disabled={isPending} 
                ...
                <div className="space-y-2">
                    ...
                    <Select 
                        name="level" 
                        defaultValue={(state.payload?.get('level') as string) ?? initialData.level}
                        disabled={isPending}
                    >
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div className="space-y-2">
                            ...
                            <Input 
                                ...
                                name="startDate" 
                                type="date"
                                defaultValue={(state.payload?.get('startDate') as string) ?? (initialData.startDate ? new Date(initialData.startDate).toISOString().split('T')[0] : '')}
                                disabled={isPending} 
                            />
                        </div>
                        ...
                        <div className="space-y-2">
                            ...
                            <Input 
                                ...
                                defaultValue={(state.payload?.get('schedule') as string) ?? (initialData.schedule || '')}
                                disabled={isPending} 
                            />
                        </div>
                        ...
                        <div className="space-y-2">
                            ...
                            <Input 
                                ...
                                defaultValue={(state.payload?.get('location') as string) ?? (initialData.location || '')}
                                disabled={isPending} 
                            />
                        </div>
                        ...
                        <div className="space-y-2">
                            ...
                            <Input 
                                ...
                                type="number"
                                min="0"
                                defaultValue={(state.payload?.get('maxStudents') as string) ?? (initialData.maxStudents ?? 0)}
                                disabled={isPending} 
                            />
                        </div>
                            ...
                            <div className="flex gap-2">
                                ...
                                <div className="w-2/3">
                                    <Input 
                                        ...
                                        step="0.01"
                                        min="0"
                                        defaultValue={(state.payload?.get('price') as string) ?? (initialData.price ?? 0)}
                                        disabled={isPending} 
